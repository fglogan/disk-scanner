//! Core data models for disk scanning and cleanup operations.
//!
//! This module contains all serializable data structures used for communication
//! between Tauri backend and frontend, as well as internal request/response types.
...
/// Collection of duplicate files with same content hash
#[derive(Serialize, Deserialize, Clone, Debug)]
...
pub struct JunkCategory {
    ...
    /// Overall safety level for category
    pub safety: String,
...
pub struct CacheEntry {
    ...
    /// Safety level: "safe", "caution", or "dangerous"
    pub safety: String,
    /// Human-readable description of cache
...
#[derive(Serialize, Deserialize, Clone, Debug)]
pub struct GitEntry {
    /// Absolute path to file within repository
    pub path: String,
    /// Size in megabytes
    pub size_mb: f32,
